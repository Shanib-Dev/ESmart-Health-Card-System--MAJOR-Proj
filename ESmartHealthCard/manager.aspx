<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager.aspx.cs" Inherits="ESmartHealthCard.manager" %>
...
<body>
    ...
    <div style=" text-align:left; height: 78px;"> 
        ...
        <asp:Button ID="txthome" runat="server" Text="HOME" Height="40px" Width="100px" 
                onclick="txthome_Click" BackColor="#9966FF" /> 
        </div>
    <h1 align="center" 
            style="font-family: Algerian; font-size: xx-large; font-weight: 600; font-style: normal; font-variant: normal; text-transform: uppercase; color: #000080; text-decoration: blink; line-height: 0px; background-image: inherit; height: 57px; width: 1017px;">Manager</h1>
    
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         Manager ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="txtmanagerid" runat="server"></asp:TextBox>
          &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:Button ID="btnsave" runat="server" Text="Save" onclick="btnsave_Click" />&nbsp&nbsp;&nbsp;&nbsp;
         <asp:Button ID="btnedit" runat="server" Text="Edit" onclick="btnedit_Click" />&nbsp&nbsp;&nbsp;&nbsp;
          <asp:Button ID="btndelete" runat="server" Text="Delete" 
            ...
            onclientclick="return confirm('Are you sure you want to delete ?');" />&nbsp&nbsp;&nbsp;&nbsp;
