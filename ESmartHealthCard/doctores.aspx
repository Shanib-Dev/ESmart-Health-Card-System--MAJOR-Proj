<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="doctores.aspx.cs" Inherits="ESmartHealthCard.doctores" %>
...
<body>
    ...
    <div style=" text-align:left; height: 78px;"> 
        ...
        <asp:Button ID="txthome" runat="server" Text="HOME" Height="40px" Width="100px" 
                 BackColor="#9966FF" onclick="txthome_Click" /> 
        </div>
    <h1 align="center" 
            style="font-family: Algerian; font-size: xx-large; font-weight: 600; font-style: normal; font-variant: normal; text-transform: uppercase; color: #000080; text-decoration: blink; line-height: 0px; background-image: inherit; height: 57px; width: 1017px;">Doctor</h1>
    
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         Doctor ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="txtdoctorid" runat="server"></asp:TextBox>
          &nbsp;&nbsp;&nbsp;&nbsp;
