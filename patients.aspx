<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="patients.aspx.cs" Inherits="ESmartHealthCard.patients" %>
...
<body>
   ...
   <asp:Button ID="btnlogout" runat="server" Text="HOME" Height="40px" 
           Width="100px" BackColor="#FF66FF" onclick="btnlogout_Click1" />
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   </div>
    <center>
